...
// Validate ../../src/app/api/admin/approve-instructor/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/approve-instructor">> = Specific
  const handler = {} as typeof import("../../src/app/api/admin/approve-instructor/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/api/admin/reject-instructor/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/admin/reject-instructor">> = Specific
  const handler = {} as typeof import("../../src/app/api/admin/reject-instructor/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
